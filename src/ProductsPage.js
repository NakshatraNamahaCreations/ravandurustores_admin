...
const ProductsPage = ({ existingProductData }) => {
  ...
  const [newProduct, setNewProduct] = useState({
    ...
    categoryId: "",
    description: "",
    ingredientsDescription: "", // Added new field
    stock: "",
    images: [null, null, null, null, null],
    discountPercentage: "", // Changed from discountPrice
    variants: [],
    unit: "",
    quantity: "",
    variantPrice: "",
  ...
  const handleAddProduct = async () => {
    if (
      ...
      !newProduct.categoryId ||
      !newProduct.description ||
      !newProduct.ingredientsDescription || // Added validation
      !newProduct.stock ||
      !newProduct.variants[0]?.quantity ||
      !newProduct.variants[0]?.price ||
      !newProduct.variants[0]?.unit
    ...
    formData.append("category", newProduct.category);
    formData.append("description", newProduct.description);
    formData.append("ingredientsDescription", newProduct.ingredientsDescription); // Added new field
    formData.append("stock", newProduct.stock);
    formData.append("discountPercentage", newProduct.discountPercentage || 0); // Changed from discountPrice
    formData.append("variants", JSON.stringify(newProduct.variants));
    ...
    try {
      ...
      if (response.data.message) {
        ...
        setNewProduct({
          ...
          categoryId: "",
          description: "",
          ingredientsDescription: "", // Reset new field
          stock: "",
          images: [null, null, null, null, null],
          discountPercentage: "", // Changed from discountPrice
          variants: [],
  ...
  const handleEditProduct = (productId) => {
    ...
    setNewProduct({
      ...
      category: productToEdit.category || "",
      categoryId: matchedCategory?._id || "",
      ingredientsDescription: productToEdit.ingredientsDescription || "", // Added new field
      images: productToEdit.images.map((img) => img),
      discountPercentage: productToEdit.discountPercentage || "", // Changed from discountPrice
      variants: productToEdit.variants || [],
        ...
        <div className="col-md-12">
          {isAddingProduct ? (
            ...
            >
              ...
              {/* Inputs: Name, Category, Stock, Description, Ingredients Description, Discount Percentage */}
              <div
                style={{ display: "flex", flexDirection: "column", gap: "12px" }}
              >
                <input
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setNewProduct({ ...newProduct, ingredientsDescription: e.target.value })
                  }
                  style={{ ...inputStyle, resize: "none" }}
                />
              </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <strong>Discount Percentage:</strong> {selectedProduct.discountPercentage || "0"}%
                        </div>
                      </div>
